...
export class CheckoutComponent implements OnInit {
  ...
  onSubmit() {
    ...
    // populate the purchase - customer
    purchase.customer = this.checkoutFormGroup.controls['customer'].value;

    // populate the purchase - shipping address
    ...
    // populate the purchase - billing address
    ...
    // populate the purchase - order and orderItems
  ...
  getStates(formGroupName: string) {
    ...
    this.kaminoCodeFormService.getStates(countryCode).subscribe((data) => {
